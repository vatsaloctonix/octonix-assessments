...
export const DOMAIN_QUESTIONS: Record<RoleId, DomainQuestion[]> = {
  ...
  product_manager: [
    ...
    { id: "pm_2", kind: "mcq", prompt: "A good PRD should primarily…", options: ["List UI colors", "Describe the problem, users, and success metrics", "Avoid measurable goals", "Only contain engineering tasks"], correctAnswer: "Describe the problem, users, and success metrics" },
    { id: "pm_3", kind: "text", prompt: "Name 2 north-star metrics you have used (or would use)." },
    { id: "pm_4", kind: "mcq", prompt: "What is an MVP?", options: ["Most Valuable Product", "Minimum Viable Product", "Maximum Verified Plan", "Market Validation Package"], correctAnswer: "Minimum Viable Product" },
    { id: "pm_5", kind: "text", prompt: "How do you decide what to build next? (short)" },
    { id: "pm_6", kind: "mcq", prompt: "Which is a prioritization framework?", options: ["RICE", "RGB", "HTTP", "CRUD"], correctAnswer: "RICE" },
    ...
    { id: "pm_9", kind: "mcq", prompt: "A/B testing helps with…", options: ["Replacing QA", "Comparing impact of two variants", "Writing specs", "Reducing server cost"], correctAnswer: "Comparing impact of two variants" },
  ...
  financial_analyst: [
    { id: "fa_1", kind: "mcq", prompt: "A balance sheet equation is…", options: ["Revenue - Expenses = Profit", "Assets = Liabilities + Equity", "Cash + Debt = EBITDA", "Assets - Equity = Revenue"], correctAnswer: "Assets = Liabilities + Equity" },
    { id: "fa_2", kind: "text", prompt: "Define EBITDA in one line." },
    { id: "fa_3", kind: "mcq", prompt: "Which is a liquidity ratio?", options: ["Current ratio", "Gross margin", "ROE", "EV/EBITDA"], correctAnswer: "Current ratio" },
    { id: "fa_4", kind: "text", prompt: "What is working capital? (short)" },
    { id: "fa_5", kind: "mcq", prompt: "DCF stands for…", options: ["Discounted Cash Flow", "Direct Cost Forecast", "Debt Coverage Factor", "Daily Cash Frequency"], correctAnswer: "Discounted Cash Flow" },
    { id: "fa_6", kind: "text", prompt: "What is the purpose of sensitivity analysis? (short)" },
    { id: "fa_7", kind: "mcq", prompt: "If interest rates rise, bond prices usually…", options: ["Rise", "Fall", "Stay same", "Double"], correctAnswer: "Fall" },
    { id: "fa_8", kind: "text", prompt: "Explain cash flow statement in 1–2 lines." },
    { id: "fa_9", kind: "mcq", prompt: "Which is a valuation multiple?", options: ["P/E", "Inventory turnover", "Days sales outstanding", "Net margin"], correctAnswer: "P/E" },
  ...
  business_analyst: [
    ...
    { id: "ba_2", kind: "mcq", prompt: "BRD stands for…", options: ["Business Requirement Document", "Backend Runtime Definition", "Business Risk Dashboard", "Baseline Release Design"], correctAnswer: "Business Requirement Document" },
    { id: "ba_3", kind: "text", prompt: "What is a user story? (short)" },
    { id: "ba_4", kind: "mcq", prompt: "Which is commonly used for process modeling?", options: ["BPMN", "JWT", "REST", "TCP"], correctAnswer: "BPMN" },
    { id: "ba_5", kind: "text", prompt: "What is scope creep? (short)" },
    { id: "ba_6", kind: "text", prompt: "Name 2 ways you gather requirements." },
    { id: "ba_7", kind: "mcq", prompt: "Acceptance criteria are used to…", options: ["Reject all features", "Define when a story is done", "Increase budget", "Replace QA"], correctAnswer: "Define when a story is done" },
    { id: "ba_8", kind: "text", prompt: "What is a wireframe? (short)" },
    { id: "ba_9", kind: "mcq", prompt: "Which is a prioritization method?", options: ["MoSCoW", "HTTP", "MVC", "SQL"], correctAnswer: "MoSCoW" },
  ...
  java_full_stack: [
    { id: "jfs_1", kind: "mcq", prompt: "Which is an HTTP method for updating a resource?", options: ["PUT", "TRACE", "PING", "ECHO"], correctAnswer: "PUT" },
    { id: "jfs_2", kind: "text", prompt: "What does REST mean? (short)" },
    { id: "jfs_3", kind: "mcq", prompt: "In Java, an interface is mainly used to…", options: ["Store data", "Define contracts/behaviors", "Replace classes completely", "Compile faster"], correctAnswer: "Define contracts/behaviors" },
    { id: "jfs_4", kind: "text", prompt: "What is a primary key? (short)" },
    { id: "jfs_5", kind: "mcq", prompt: "Which is a common Java build tool?", options: ["Maven", "Nginx", "Docker", "Redis"], correctAnswer: "Maven" },
    { id: "jfs_6", kind: "text", prompt: "What is CORS? (short)" },
    { id: "jfs_7", kind: "mcq", prompt: "What does SQL JOIN do?", options: ["Deletes rows", "Combines rows from tables", "Encrypts data", "Creates UI"], correctAnswer: "Combines rows from tables" },
    { id: "jfs_8", kind: "text", prompt: "Define API in one line." },
    { id: "jfs_9", kind: "mcq", prompt: "Which is front-end framework/library?", options: ["React", "JUnit", "Hibernate", "JDBC"], correctAnswer: "React" },
  ...
  python_full_stack: [
    { id: "pfs_1", kind: "mcq", prompt: "In Python, a dictionary is…", options: ["Ordered list", "Key-value mapping", "Binary tree", "Database table"], correctAnswer: "Key-value mapping" },
    { id: "pfs_2", kind: "text", prompt: "What is a virtual environment? (short)" },
    { id: "pfs_3", kind: "mcq", prompt: "Which is a Python web framework?", options: ["Django", "Gradle", "JUnit", "Kafka"], correctAnswer: "Django" },
    { id: "pfs_4", kind: "text", prompt: "What is an API endpoint? (short)" },
    { id: "pfs_5", kind: "mcq", prompt: "SQL injection is prevented mainly by…", options: ["String concat", "Parameterized queries", "More RAM", "Bigger servers"], correctAnswer: "Parameterized queries" },
    { id: "pfs_6", kind: "text", prompt: "What is CORS? (short)" },
    { id: "pfs_7", kind: "mcq", prompt: "Which is a package manager for Python?", options: ["pip", "npm", "gem", "cargo"], correctAnswer: "pip" },
    { id: "pfs_8", kind: "text", prompt: "What is a migration in databases? (short)" },
    { id: "pfs_9", kind: "mcq", prompt: "Which HTTP status means 'not found'?", options: ["404", "200", "201", "500"], correctAnswer: "404" },
